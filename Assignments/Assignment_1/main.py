...
def train_plot_net(module_name):
    ...
    net1.set_train_param(batch_size = 32, max_nb_of_epochs = 800, learning_rate = 0.002, momentum = 0.1, lrate_drop = 0.75, epochs_drop = 20)
    ...
    plot.plot_costs(module_name, res["nb_of_epochs"], res["nb_of_batches"], res["minibatch_costs"], res["train_costs"], res["val_costs"], res["test_costs"])
